...
public class Cargo {
	...
	private String FechaIngreso, FechaRetiro, Area, Cargo, CargoEvaluar, ElementosDeProteccion, Empresa,
			JornadaDeTrabajo, unidad;
	...
	public Cargo(String area, String cargo, String cargoEvaluar, String elementosDeProteccion, String empresa,
			...
			int horasTrabajadas, String fechaIngreso, String fechaRetiro, Date fechaDeDiligenciamiento,
